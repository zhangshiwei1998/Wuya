package com.zhangshiwei1024.util.quartz;

import lombok.extern.slf4j.Slf4j;
import org.quartz.JobExecutionContext;
import org.springframework.scheduling.quartz.QuartzJobBean;
import com.zhangshiwei1024.entity.ScheduleJobLog;
import com.zhangshiwei1024.service.ScheduleJobService;
...
public class ScheduleJob extends QuartzJobBean {
	...
	protected void executeInternal(JobExecutionContext context) {
		com.zhangshiwei1024.entity.ScheduleJob scheduleJob = (com.zhangshiwei1024.entity.ScheduleJob) context.getMergedJobDataMap().get(com.zhangshiwei1024.entity.ScheduleJob.JOB_PARAM_KEY);
		//获取spring bean
