package com.zhangshiwei1024.util.comment;
...
import com.zhangshiwei1024.constant.PageConstants;
...
import com.zhangshiwei1024.util.HashUtils;
import com.zhangshiwei1024.util.IpAddressUtils;
import com.zhangshiwei1024.util.MailUtils;
import com.zhangshiwei1024.util.QQInfoUtils;
import com.zhangshiwei1024.util.StringUtils;
import com.zhangshiwei1024.util.comment.channel.ChannelFactory;
import com.zhangshiwei1024.util.comment.channel.CommentNotifyChannel;
import com.zhangshiwei1024.enums.CommentOpenStateEnum;
...
public class CommentUtils {
	 ...
	 */
	public void judgeSendNotify(Comment comment, boolean isVisitorComment, com.zhangshiwei1024.entity.Comment parentComment) {
	 ...
	 * @param comment       当前收到的评论
	 */
	private void sendMailToParentComment(com.zhangshiwei1024.entity.Comment parentComment, Comment comment) {
